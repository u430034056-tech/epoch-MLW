...
> 2026-05-13 submission note: 本 README 记录的是 XGBoost 分支的历史实验路线。当前最终可提交版本已经固定为 `01_本地副本_实验/final_submission_2026-05-13/final_submission_public_0p81412.csv`，Kaggle public score 为 `0.81412`。下文中 `submission_v2_best.csv` 的“最终推荐”说法只保留为当时的干净方法主线记录，不再代表当前最终提交文件。
...
PYTHONPATH=. python -m src.xgboost.run_public_style \
  --data-dir "/Users/shenyijie/Desktop/20260319_xgboost 2/data/raw" \
