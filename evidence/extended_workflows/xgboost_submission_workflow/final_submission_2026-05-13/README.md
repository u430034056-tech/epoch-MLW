...
- Submission source: `submission_team_common_rawlike_feedback_rank_k3_seed17_w05_true2291.csv`
...
For the report, describe this as a Kaggle public-feedback recovery result and final submission choice. Do not present the `0.81412` score as proof that any public-feedback perturbation is generally superior, because tied candidates can share the same public score.
